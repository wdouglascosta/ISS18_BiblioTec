package com.uem.login.controller;

import javax.validation.Valid;

import com.uem.login.model.User;
import com.uem.login.service.UserService;
...
public class LoginController {
    ...
    public ModelAndView home(){
        ...
        modelAndView.addObject("userName", "BemVindo " + user.getName() + " " + user.getCpf() + " (" + user.getEmail() + ")");
